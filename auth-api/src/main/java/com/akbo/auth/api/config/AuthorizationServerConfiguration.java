...
public class AuthorizationServerConfiguration {
    ...
    public SecurityFilterChain authorizationServerSecurityFilterChain(
            ...
            final OAuth2PasswordAuthenticationProvider passwordAuthenticationProvider)
            throws Exception {
    ...
    public RegisteredClientRepository registeredClientRepository(
        ...
        final Duration accessTokenTtl =
                parseDuration(accessTokenTtlValue, "app.auth.access-token-ttl");
        final Duration refreshTokenTtl =
                parseDuration(refreshTokenTtlValue, "app.auth.refresh-token-ttl");
        ...
        final RegisteredClient.Builder clientBuilder =
    ...
    public JWKSource<SecurityContext> jwkSource(
            @Value("${spring.security.oauth2.resource-owner.jwt.signing-key}")
                    final String symKey) {
